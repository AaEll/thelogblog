...
set of algorithms within industry [4]. *Salient terms* has come to represent a variety of term weighting algorithm with the goal of highly weighting terms related to the subject of the document [4].
