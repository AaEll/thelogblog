...
However, more recently this round has began to place more emphasis on Transformer concepts. The round has started blending classical and modern theory. Example questions include:

- When would you use data-parallel vs pipeline-parallel training for a LLM? What factors lead to the decision?
- Explain the tradeoffs between RoPE and sinusoidal positional embeddings. When would you prefer one over the other?
- Compare the tradeoffs between scaled dot-product attention, multi-head attention, latent attention and grouped-query attention. Why has Latent Attention & Grouped Query Attention become common in modern LLMs?
...
At AI-focused companies, the prompt is increasingly likely to involve an LLM in some capacity: "Design a retrieval-augmented generation system for our support chatbot" or
