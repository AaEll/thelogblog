...
set of algorithms within industry, used at companies across Silicon Valley, spread by the exodus of Nooglers spreading the ideas behind 
the industry leading search engine [4].
...
Salient terms can be used to the highest weight documents using a inverse index. 
Alternatively, the term weights can be used in heuristic algorithms e.g. page-rank. 
Lastly, term weights can be used as features in downstream ranking models.  
...
I tried to avoid sharing any information not already widely known in the industry, comparing notes from colleagues who work(ed) at dozens of US, Singaporean and Chinese tech giants. 
Luckily Im not currently subject to any NDA. So I can share this information freely :D
