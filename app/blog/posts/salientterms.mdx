...
are not scalable to evaluating hundreds of millions of items within the 250ms users expect from search and recommendations applications [7][8].
...
to webscale problems [4][6]. Salient terms fits neatly into the retrieval layer as another performant heuristic algorithm for modelling query\<\-\>item relevance.
